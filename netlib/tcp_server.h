...
private:
	...
	// create TcpConnection. name_ is the key of connection_map_.
	const std::string name_;
	// Use Acceptor to get the new connection's file descriptor.
	// When new connection arrives, acceptor_ calls NewConnection().
